...
EMSCRIPTEN_BINDINGS(Clipper2Lib) {
  ...
  class_<Clipper64>("Clipper")
    ...
    .function("executeToPaths", select_overload<bool(ClipType, FillRule, Paths64 &)>(&Clipper64::Execute))
    .function("executeToPathsOpen", select_overload<bool(ClipType, FillRule, Paths64 &, Paths64 &)>(&Clipper64::Execute))
    .function("executeToPolyTree", select_overload<bool(ClipType, FillRule, PolyTree64 &)>(&Clipper64::Execute))
    .function("executeToPolyTreeOpen", select_overload<bool(ClipType, FillRule, PolyTree64 &, Paths64 &)>(&Clipper64::Execute))
#ifdef use_xyz
  ...
  class_<ClipperOffset>("ClipperOffset")
      ...
      .function("executeToPaths", select_overload<void(double, Paths64&)>(&ClipperOffset::Execute))
      .function("executeToPolyTree", select_overload<void(double, PolyTree64&)>(&ClipperOffset::Execute))
