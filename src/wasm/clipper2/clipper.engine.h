...
namespace Clipper2Lib {
	...
	public:
		...
		bool JS_GetPreserveCollinear() const {return PreserveCollinear;};
		void JS_SetPreserveCollinear(bool value) {PreserveCollinear = value;};
		bool JS_GetReverseSolution() const {return ReverseSolution;};
		void JS_SetReverseSolution(bool value) {ReverseSolution = value;};
#ifdef USINGZ
		int64_t DefaultZ = 0;
#endif
	};
